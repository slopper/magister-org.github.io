<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong>Добавление промокода</strong>
            </li>
        </ol>
    </div>
    <div class="col-sm-8">
        <div class="title-action">
            <a href="/shares/promo" class="btn btn-primary">Список промокодов</a>
        </div>
    </div>
</div>
    ...
    <div class="ibox float-e-margins">
        <?php
            if(isset($_POST['name'])) {
                    ...
                    $query = "INSERT INTO `promoCodes`(`text`, `activeCount`, `discount`) VALUES ('{$name}', '{$count}', '{$balance}');";
                    if(mysqli_query($_MS_ID, $query)) showMessage("info", "Промо создан, ID — ".mysqli_insert_id($_MS_ID));
                    else showMessage("warning", "При добавлении купона произошла ошибка");
                
            }
        ?>
        <div class="ibox-title"><h5>Добавление промокода</h5></div>
        <div class="ibox-content">
            <form class="form-horizontal" method="POST" id="formx" action="">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">Скидка в %:</label>
                    <div class="col-sm-10">
